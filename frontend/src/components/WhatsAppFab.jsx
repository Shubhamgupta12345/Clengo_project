...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_rgb(37,211,102,0.4)] flex items-center justify-center hover:scale-105 active:scale-95 transition-transform duration-200"
    >
